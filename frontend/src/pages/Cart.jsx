...
const Cart = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <h1 className="text-4xl font-extrabold text-gray-900 mb-10 tracking-tight">Mon Panier <span className="text-agri-green text-2xl font-bold ml-2">({cartCount} kg)</span></h1>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                {/* Cart Items + bouton mise à jour */}
